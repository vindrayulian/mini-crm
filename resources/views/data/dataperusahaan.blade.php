            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <form action="/perusahaan" method="GET" role="search" class="app-search d-none d-md-block me-3">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <nav class="navbar">
                                <div class="container-fluid">
                                    <a href="/tambahperusahaan" class="btn btn-primary">Tambah Data</a>
                                    <form action="/perusahaan" method="GET" class="d-flex" role="search">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        @foreach ($isi as $index => $row)
                                            <tr> 
                                                <td>{{$index + $isi->firstItem()}}</td>
                                                {{-- <td>{{$row->id}}</td> --}}
                                                <td>{{$row->nama}}</td>
                                                <td>
                                                ...
                                                <td>{{$row->website}}</td>
                                                <td>
                                                    <a href="/tampilperusahaan/{{$row->id}}" class="btn btn-warning">Edit</a>
                                                    <a href="{{route('hapus',$row->id)}}" class="btn btn-danger">Delete</a>  
                                                </td>
                                            </tr> 
                                        @endforeach
